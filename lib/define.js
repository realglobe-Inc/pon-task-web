 ...
 * @param {Array} [options.browser] - Options for pon-task-browser
 * @param {Array} [options.react] - Options for pon-task-react
 * @param {Array} [options.css] - Options for pon-task-css
 * @param {Array} [options.map] - Options for pon-task-map
